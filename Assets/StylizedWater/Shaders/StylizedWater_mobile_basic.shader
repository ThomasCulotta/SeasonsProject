    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 normalLocal = lerp(float3(0.5,0.5,1),NormalMap.rgb,_NormalStrength);
